...
/* harmony import */ var _interface__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../interface */ "./node_modules/rc-motion/es/interface.js");
...
/* harmony import */ var _useStepQueue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./useStepQueue */ "./node_modules/rc-motion/es/hooks/useStepQueue.js");
...
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var _useState3 = (0,rc_util_es_hooks_useState__WEBPACK_IMPORTED_MODULE_4__.default)(_interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_NONE),
  ...
  var mountedRef = (0,react__WEBPACK_IMPORTED_MODULE_5__.useRef)(false);
  var deadlineRef = (0,react__WEBPACK_IMPORTED_MODULE_5__.useRef)(null);
  ...
  // ========================== Motion End ==========================
  var activeRef = (0,react__WEBPACK_IMPORTED_MODULE_5__.useRef)(false);

  /**
   * Clean up status & style
   */
  function updateMotionEndStatus() {
    setStatus(_interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_NONE, true);
    setStyle(null, true);
  }
  var onInternalMotionEnd = (0,rc_util__WEBPACK_IMPORTED_MODULE_3__.useEvent)(function (event) {
    // Do nothing since not in any transition status.
    // This may happen when `motionDeadline` trigger.
    if (status === _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_NONE) {
      return;
    }
    ...
    var canEnd;
    if (status === _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_APPEAR && currentActive) {
      canEnd = onAppearEnd === null || onAppearEnd === void 0 ? void 0 : onAppearEnd(element, event);
    } else if (status === _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_ENTER && currentActive) {
      canEnd = onEnterEnd === null || onEnterEnd === void 0 ? void 0 : onEnterEnd(element, event);
    } else if (status === _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_LEAVE && currentActive) {
  ...
  var getEventHandlers = function getEventHandlers(targetStatus) {
    switch (targetStatus) {
      case _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_APPEAR:
        return (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)((0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)((0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)({}, _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_PREPARE, onAppearPrepare), _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_START, onAppearStart), _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_ACTIVE, onAppearActive);
      case _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_ENTER:
        return (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)((0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)((0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)({}, _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_PREPARE, onEnterPrepare), _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_START, onEnterStart), _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_ACTIVE, onEnterActive);
      case _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_LEAVE:
        return (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)((0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)((0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)({}, _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_PREPARE, onLeavePrepare), _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_START, onLeaveStart), _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_ACTIVE, onLeaveActive);
      default:
        return {};
    }
  };
  var eventHandlers = react__WEBPACK_IMPORTED_MODULE_5__.useMemo(function () {
    return getEventHandlers(status);
  }, [status]);
  var _useStepQueue = (0,_useStepQueue__WEBPACK_IMPORTED_MODULE_9__.default)(status, !supportMotion, function (newStep) {
      // Only prepare step can be skip
      if (newStep === _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_PREPARE) {
        var onPrepare = eventHandlers[_interface__WEBPACK_IMPORTED_MODULE_6__.STEP_PREPARE];
        if (!onPrepare) {
          return _useStepQueue__WEBPACK_IMPORTED_MODULE_9__.SkipStep;
        }
      ...
      if (step === _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_ACTIVE && status !== _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_NONE) {
      ...
      if (step === _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_PREPARED) {
        updateMotionEndStatus();
      }
      return _useStepQueue__WEBPACK_IMPORTED_MODULE_9__.DoStep;
    }),
    _useStepQueue2 = (0,_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__.default)(_useStepQueue, 2),
    startStep = _useStepQueue2[0],
    step = _useStepQueue2[1];
  var active = (0,_useStepQueue__WEBPACK_IMPORTED_MODULE_9__.isActive)(step);
  ...
  (0,_useIsomorphicLayoutEffect__WEBPACK_IMPORTED_MODULE_8__.default)(function () {
    ...
    if (!isMounted && visible && motionAppear) {
      nextStatus = _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_APPEAR;
    }

    // Enter
    if (isMounted && visible && motionEnter) {
      nextStatus = _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_ENTER;
    }

    // Leave
    if (isMounted && !visible && motionLeave || !isMounted && motionLeaveImmediately && !visible && motionLeave) {
      nextStatus = _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_LEAVE;
    }
    var nextEventHandlers = getEventHandlers(nextStatus);

    // Update to next status
    if (nextStatus && (supportMotion || nextEventHandlers[_interface__WEBPACK_IMPORTED_MODULE_6__.STEP_PREPARE])) {
      setStatus(nextStatus);
      startStep();
    } else {
      // Set back in case no motion but prev status has prepare step
      setStatus(_interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_NONE);
    }
  }, [visible]);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_5__.useEffect)(function () {
    if (
    // Cancel appear
    status === _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_APPEAR && !motionAppear ||
    // Cancel enter
    status === _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_ENTER && !motionEnter ||
    // Cancel leave
    status === _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_LEAVE && !motionLeave) {
      setStatus(_interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_NONE);
    }
  ...
  var firstMountChangeRef = react__WEBPACK_IMPORTED_MODULE_5__.useRef(false);
  (0,react__WEBPACK_IMPORTED_MODULE_5__.useEffect)(function () {
    // [visible & motion not end] => [!visible & motion end] still need trigger onVisibleChanged
    if (asyncVisible) {
      firstMountChangeRef.current = true;
    }
    if (asyncVisible !== undefined && status === _interface__WEBPACK_IMPORTED_MODULE_6__.STATUS_NONE) {
  ...
  if (eventHandlers[_interface__WEBPACK_IMPORTED_MODULE_6__.STEP_PREPARE] && step === _interface__WEBPACK_IMPORTED_MODULE_6__.STEP_START) {
