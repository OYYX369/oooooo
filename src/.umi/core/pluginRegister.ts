...
import * as Plugin_2 from 'E:/rfid/user-center-frontend-master/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_5 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: 'E:/rfid/user-center-frontend-master/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
